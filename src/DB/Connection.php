...
class Connection
{
  ...
  //Quando tem uma instancia na memória eu pego ela, caso ela não exista eu vou criar ela e retornar
  ...
  public static function getInstance()
  {
      ...
      if(is_null(self::$instance)){
        ...
        //trás os dados já formatados do UTF8 para não termos problemas os caracteres
